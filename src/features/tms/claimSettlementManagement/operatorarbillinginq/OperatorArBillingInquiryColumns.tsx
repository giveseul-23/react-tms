...
export const MAIN_COLUMN_DEFS = [
  { headerName: "No" },
  { type: "text", headerName: "LBL_AR_SETTLEMENT_DOC_NO", field: "AR_ID" },
  {
    type: "text",
...
export const BILLING_ITEM_COLUMN_DEFS = [
  { headerName: "No" },
  { type: "text", headerName: "LBL_OPER_TCD", field: "AR_CHG_CD" },
  { type: "text", headerName: "LBL_OPER_TNM", field: "AR_CHG_NM" },
  {
    type: "text",
  ...
  { type: "text", headerName: "LBL_GL_LDGR_CD", field: "GL_LDGR_CD" },
  {
    type: "text",

...
export const MAIN_COLUMN_DEFS = [
  ...
  {
    type: "text",
    headerName: "LBL_FIXED_ADDR",
    field: "VALID_ADDR",
  },
  {
    type: "number",
    headerName: "LBL_BASE_TIME",
    field: "FIX_LD_UNLD_MIN",
    editable: true,
    insertable: true,
    validators: {
      required: true,
  ...
  {
    type: "text",
    headerName: "LBL_REPRESENTATIVE_MBL_NO",
    field: "REP_MOBNO",
    editable: true,
    insertable: true,
    regexTp: "PHONE",
  ...
  {
    type: "text",
    headerName: "LBL_REPRESENTATIVE_FAX",
    field: "REP_FAXNO",
    editable: true,
    insertable: true,
  },
  {
    type: "text",
    headerName: "LBL_REPRESENTATIVE_EMAIL",
    field: "REP_EMAIL",
    editable: true,
    insertable: true,
  },

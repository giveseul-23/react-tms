...
import { useTemperatureRangeManagementModel } from "./TemperatureRangeManagementModel";
import { useTemperatureRangeManagementController } from "./TemperatureRangeManagementController";
...
export default function Feature() {
  ...
  const ctrl = useTemperatureRangeManagementController({ model });

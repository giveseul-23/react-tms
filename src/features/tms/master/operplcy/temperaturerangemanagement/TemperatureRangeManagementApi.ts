...
export const temperatureRangeManagementApi = {
  // ── 메인 조회 ─────────────────────────────────────────────────
  getList(payload: any) {
    return apiClient.post<CommonResponse>(
      `/temperatureRangeManagementService/search`,
  ...
  save(payload: any) {
    ...
    return apiClient.post<CommonResponse>(
      `/temperatureRangeManagementService/save`,
      { dsSave },
      {
        params: {
          ...getSessionFields(),
  ...
  remove(payload: any) {
    return apiClient.post<CommonResponse>(
      `/temperatureRangeManagementService/delete`,
      withSession({ MENU_CD: MENU_CODE, ...payload }),
    );
  },
};

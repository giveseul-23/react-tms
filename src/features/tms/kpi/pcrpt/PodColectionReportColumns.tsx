...
export const MAIN_COLUMN_DEFS: any[] = [
  ...
  {
    type: "numeric",
    headerName: "LBL_ISSUED_POD_COUNT",
    field: "PRINT_CNT",
    width: 120,
  },
  {
    type: "numeric",
    headerName: "LBL_COLLECTED_POD_COUNT",
    field: "COLLECT_CNT",
    width: 120,
  },
  {
    type: "numeric",
    headerName: "LBL_NON_COLLECTED_POD_COUNT",
    field: "UN_COLLECT_CNT",
    width: 120,
  },
  {
    type: "numeric",
    headerName: "LBL_COLLECT_RATIO",
    field: "COLLECT_PERCNT",
    width: 100,
  },
  // 하위 그리드 조회 파라미터 (서버 hidden 컬럼)
  {
    type: "text",
    headerName: "DLVRY_DT_FR",
    field: "DLVRY_DT_FR",
    noLang: true,
    hide: true,
  },

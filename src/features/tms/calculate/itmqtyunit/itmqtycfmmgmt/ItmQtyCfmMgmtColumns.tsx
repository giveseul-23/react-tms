...
export const MAIN_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_PLAN_VALUE", field: "PLN_QTY", width: 100, validators: { min: 0 }, summaryType: "sum" },
  {
    type: "numeric",
  ...
  { type: "numeric", headerName: "LBL_ITM_TOTAL_COST", field: "ITM_TOTAL_COST", width: 90, summaryType: "sum" },
...
export const SUB01_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_VOL", field: "PLN_VOL", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_WGT", field: "PLN_WGT", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY1", field: "PLN_FLEX_QTY1", align: "right", width: 120, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY2", field: "PLN_FLEX_QTY2", align: "right", width: 120, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY3", field: "PLN_FLEX_QTY3", align: "right", width: 120, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY4", field: "PLN_FLEX_QTY4", align: "right", width: 120, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY5", field: "PLN_FLEX_QTY5", align: "right", width: 120, summaryType: "sum" },
...
export const SUB02_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_PLANNED_QTY", field: "PLN_QTY", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_PLN_VOL", field: "PLN_VOL", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLN_WGT", field: "PLN_WGT", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLANNED_FLEX_QTY1", field: "PLN_FLEX_QTY1", align: "right", width: 80, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLANNED_FLEX_QTY2", field: "PLN_FLEX_QTY2", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLANNED_FLEX_QTY3", field: "PLN_FLEX_QTY3", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLANNED_FLEX_QTY4", field: "PLN_FLEX_QTY4", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_PLANNED_FLEX_QTY5", field: "PLN_FLEX_QTY5", align: "right", width: 90, summaryType: "sum", decimalPlaces: 4 },
  { type: "numeric", headerName: "LBL_CONFIRMED_QTY", field: "CFM_QTY", align: "right", width: 100, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CONFIRMED_VOL", field: "CFM_VOL", align: "right", width: 100, summaryType: "sum", decimalPlaces: 2 },
  { type: "numeric", headerName: "LBL_CONFIRMED_WGT", field: "CFM_WGT", align: "right", width: 100, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CONFIRMED_FLEX_QTY1", field: "CFM_FLEX_QTY1", align: "right", width: 100, summaryType: "sum", decimalPlaces: 2 },
  { type: "numeric", headerName: "LBL_CONFIRMED_FLEX_QTY2", field: "CFM_FLEX_QTY2", align: "right", width: 100, summaryType: "sum", decimalPlaces: 2 },
  { type: "numeric", headerName: "LBL_CONFIRMED_FLEX_QTY3", field: "CFM_FLEX_QTY3", align: "right", width: 100, summaryType: "sum", decimalPlaces: 2 },
  { type: "numeric", headerName: "LBL_CONFIRMED_FLEX_QTY4", field: "CFM_FLEX_QTY4", align: "right", width: 100, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CONFIRMED_FLEX_QTY5", field: "CFM_FLEX_QTY5", align: "right", width: 100, summaryType: "sum" },
...
export const SUB03_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_UNIT_COST", field: "CHG_RATE", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_RATE", field: "CHH_TTL_PLN_RATE", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_QTY_PER_BOX", field: "QTY_PER_BOX", align: "right", width: 100, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CONFIRMED_QTY", field: "CFM_QTY", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CAL_BOX_QTY", field: "CAL_BOX_QTY", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CAL_REMAIN_QTY", field: "CAL_REMAIN_QTY", align: "right", width: 90, summaryType: "sum" },
  { type: "numeric", headerName: "LBL_CAL_WGT", field: "CAL_WGT", align: "right", width: 90, summaryType: "sum" },
];

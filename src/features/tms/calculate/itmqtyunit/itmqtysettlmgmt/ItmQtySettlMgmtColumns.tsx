...
export const MAIN_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_CONFIRMED_QTY", field: "CFM_QTY", summable: true, width: 100 },
  { type: "numeric", headerName: "LBL_TOTAL_INS_COST", field: "TTL_PLN_RATE", summable: true, width: 100, valueFormatter: decimalFormatter },
  { type: "numeric", headerName: "LBL_TOTAL_ADJ_COST", field: "TTL_CFM_RATE", summable: true, width: 100, valueFormatter: decimalFormatter },
...
export const SUB01_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_INS_COST", field: "PLN_RATE", summable: true, width: 100, valueFormatter: decimalFormatter },
  { type: "numeric", headerName: "LBL_CONFIRM_COST", field: "CFM_RATE", insertable: true, editable: true, summable: true, width: 100, valueFormatter: decimalFormatter },
...
export const SUB02_COLUMN_DEFS = [
  ...
  { type: "numeric", headerName: "LBL_UNIT_COST", field: "RATE", summable: true, width: 80, valueFormatter: decimalFormatter },

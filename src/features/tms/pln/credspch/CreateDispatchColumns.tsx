...
export const MAIN_COLUMN_DEFS = [
  ...
  { type: "text", headerName: "ITNR_ID", field: "ITNR_ID", hide: true },
  { type: "text", headerName: "FRM_ZIP_CD", field: "FRM_ZIP_CD", hide: true },
  { type: "text", headerName: "FRM_LAT", field: "FRM_LAT", hide: true },
  { type: "text", headerName: "FRM_LON", field: "FRM_LON", hide: true },
  { type: "text", headerName: "TO_ZIP_CD", field: "TO_ZIP_CD", hide: true },
  { type: "text", headerName: "TO_LAT", field: "TO_LAT", hide: true },
  { type: "text", headerName: "TO_LON", field: "TO_LON", hide: true },
  { type: "text", headerName: "AP_PROC_TP", field: "AP_PROC_TP", hide: true },
  { type: "text", headerName: "CARR_CD", field: "CARR_CD", hide: true },
  { type: "text", headerName: "VEH_ID", field: "VEH_ID", hide: true },
  { type: "text", headerName: "VEH_TP_CD", field: "VEH_TP_CD", hide: true },
  { type: "text", headerName: "VEH_NO", field: "VEH_NO", hide: true },
  { type: "text", headerName: "DRVR_ID", field: "DRVR_ID", hide: true },
  { type: "text", headerName: "DRVR_NM", field: "DRVR_NM", hide: true },
  { type: "text", headerName: "ASST_ID", field: "ASST_ID", hide: true },
  { type: "text", headerName: "ASST_NM", field: "ASST_NM", hide: true },
  { type: "text", headerName: "MIN_SHPM_NO", field: "MIN_SHPM_NO", hide: true },
  { type: "text", headerName: "PPT_SHPM_SPLIT_YN", field: "ALLOW_SHIPMENT_SPLIT", hide: true },
  { type: "text", headerName: "FromAddressId", field: "FRM_ADDR_ID", hide: true },
  { type: "text", headerName: "ToAddressId", field: "TO_ADDR_ID", hide: true },
  { type: "text", headerName: "FromLocationId", field: "FRM_LOC_ID", hide: true },
  { type: "text", headerName: "ToLocationId", field: "TO_LOC_ID", hide: true },
  { type: "text", noLang: true, headerName: "ShipmentId", field: "SHPM_ID", hide: true },
  { type: "text", noLang: true, headerName: "InterfaceReceiveType", field: "IF_RCV_TP", hide: true },
  { type: "text", headerName: "TO_DTL_ADDR2", field: "TO_DTL_ADDR2", align: "left", hide: true },
  { type: "text", headerName: "FRM_DTL_ADDR2", field: "FRM_DTL_ADDR2", align: "left", hide: true },
  { type: "text", headerName: "SEQ_NO", field: "SEQ_NO", align: "right", hide: true },
  { type: "text", headerName: "LBL_BATCH", field: "BATCH_NO", align: "right", width: 40, hide: true },
  { type: "text", headerName: "LBL_DEPARTURE_COUNTRY_NAME", field: "FRM_CTRY_NM", align: "left", hide: true },
  { type: "text", headerName: "LBL_DESTINATION_COUNTRY_NAME", field: "TO_CTRY_NM", align: "left", hide: true },
  ...
  { type: "numeric", headerName: "LBL_FLEX_QTY1", field: "PLN_FLEX_QTY1", align: "right", summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY2", field: "PLN_FLEX_QTY2", align: "right", summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY3", field: "PLN_FLEX_QTY3", align: "right", summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY4", field: "PLN_FLEX_QTY4", align: "right", summaryType: "sum" },
  { type: "numeric", headerName: "LBL_FLEX_QTY5", field: "PLN_FLEX_QTY5", align: "right", summaryType: "sum" },
...
export const SUB01_COLUMN_DEFS = [
  ...
  // ── hidden ──
  { type: "text", noLang: true, headerName: "ShipmentId", field: "SHPM_ID", hide: true },
  { type: "text", noLang: true, headerName: "ShipmentType", field: "SHPM_TP", hide: true },
  { type: "text", headerName: "LGST_GRP_CD", field: "LGST_GRP_CD", hide: true },
  { type: "text", headerName: "SHPM_NO", field: "SHPM_NO", hide: true },
  { type: "text", noLang: true, headerName: "CustCd", field: "CUST_CD", hide: true },
  { type: "text", noLang: true, headerName: "ShipmentDetailCd", field: "SHPM_DTL_ID", hide: true },
  { type: "text", noLang: true, headerName: "OrderLineNumber", field: "ORD_LINE_NO", hide: true },
  { type: "text", noLang: true, headerName: "ItemSystemCd", field: "ITEM_SYS_CD", hide: true },
  { type: "text", noLang: true, headerName: "CmdtCd", field: "CMDT_CD", hide: true },
  { type: "text", headerName: "CUST_ORD_NO", field: "CUST_ORD_NO", hide: true },
  { type: "text", headerName: "ORD_NO", field: "ORD_NO", hide: true },
  ...
  { type: "check", headerName: "LBL_SORTER_YN", field: "SORTER_YN", align: "center", width: 100, hide: true },
  { type: "text", headerName: "LBL_SAP_ORDER_TP", field: "SAP_ORD_TP", align: "right", width: 100, hide: true },
  { type: "check", headerName: "LBL_PP_YN", field: "PP_YN", align: "center", width: 100, hide: true },
  { type: "text", headerName: "LBL_ITEM_TEMP_TCD", field: "ITEM_TEMP_TCD", align: "right", width: 100, hide: true },
  { type: "check", headerName: "LBL_PL_YN", field: "PL_YN", align: "center", width: 100, hide: true },
  { type: "text", headerName: "LBL_TEAM_CD", field: "TEAM_CD", align: "right", width: 100, hide: true },
  { type: "text", headerName: "LBL_TEAM_NM", field: "TEAM_NM", align: "right", width: 100, hide: true },
  { type: "text", headerName: "LBL_DVLRY_CATGRY_CD", field: "DVLRY_CATGRY_CD", align: "right", width: 120, hide: true },
];

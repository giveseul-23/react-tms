...
export const DETAIL_COLUMN_DEFS = [
  ...
  { headerName: "LBL_PLAN_QTY", field: "PLN_QTY" },
  { headerName: "LBL_QTY_UOM", field: "PLN_QTY_UOM", codeKey: "itemUom" },
  { headerName: "LBL_TTL_NET_WGT", field: "NET_WGT" },
  { headerName: "LBL_PLN_VOL", field: "GROSS_VOL" },
  ...makeAuditColumns({
    insertPerson: true,
    insertDate: true,
    updatePerson: true,

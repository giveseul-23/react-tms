...
import { MENU_CODE } from "./IfDeliveryDestination";
...
export const featureApi = {
  ...
  getList(payload: any) {
    return apiClient.post<CommonResponse>(
      `/ifDeliveryDestinationService/search`,
  ...
  getRoleList(payload: any) {
    return apiClient.post("/ifDeliveryDestinationService/searchRole", withSession(payload));
  },
  getSalesList(payload: any) {
    return apiClient.post("/ifDeliveryDestinationService/searchSales", withSession(payload));
  },
  getAddrList(payload: any) {
    return apiClient.post("/ifDeliveryDestinationService/searchAddr", withSession(payload));
  },
  getBankAccountList(payload: any) {
    return apiClient.post("/ifDeliveryDestinationService/searchBank", withSession(payload));
  },
  getCompanyList(payload: any) {
    return apiClient.post("/ifDeliveryDestinationService/searchComp", withSession(payload));
  },
  ...
  reprocess(payload: any) {
    const { dsSave, ...rest } = payload ?? {};
    return apiClient.post<CommonResponse>(
      "/ifDeliveryDestinationService/reprocess",
      { dsSave },
      {
        params: {
          ...getSessionFields(),

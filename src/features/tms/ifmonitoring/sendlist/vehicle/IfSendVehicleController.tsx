...
import { ifSendVehicleApi as api } from "./IfSendVehicleApi";
import { MENU_CODE } from "./IfSendVehicle";
import type { ActionItem } from "@/app/components/ui/GridActionsBar";
import type { GridKey, IfSendVehicleModel } from "./IfSendVehicleModel";

interface Args {
  model: IfSendVehicleModel;
}

export function useIfSendVehicleController({ model }: Args) {

...
export function useOverheadTariffManagementModel() {
  // ── 레이아웃 ──────────────────────────────────────────────────
  ...
  // ── 상세 그리드 ───────────────────────────────────────────────
  const [subLeftDetailRowData, setSubLeftDetailRowData] =
    useState<GridData>(EMPTY_GRID);
  const [subRightDetailRowData, setSubRightDetailRowData] =
    useState<GridData>(EMPTY_GRID);
  ...
  const resetSubGrids = useCallback(() => {
    ...
    setSubLeftDetailRowData(EMPTY_GRID);
    setSubRightDetailRowData(EMPTY_GRID);
  ...
  return {
    ...
    gridData,
    setGridData,
    subLeftDetailRowData,
    setSubLeftDetailRowData,
    subRightDetailRowData,
    setSubRightDetailRowData,
    // 선택 행
    selectedHeaderRow,

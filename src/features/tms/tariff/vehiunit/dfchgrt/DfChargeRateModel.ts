...
export function useDfChargeRateModel() {
  // ── 레이아웃 ──────────────────────────────────────────────────
  ...
  // ── 상세 그리드 ───────────────────────────────────────────────
  const [subRtItemRowData, setSubRtItemRowData] = useState<any>([]);
  const [subRtCarrRowData, setSubRtCarrRowData] = useState<any>([]);
  const [subRtVehTpRowData, setSubRtVehTpRowData] = useState<any>([]);
  const [subRtItemVehTpRowData, setSubRtItemVehTpRowData] = useState<any>([]);
  const [subRtItemVehRowData, setSubRtItemVehRowData] = useState<any>([]);
  ...
  const resetSubGrids = useCallback(() => {
    ...
    setSubRtItemRowData([]);
    setSubRtCarrRowData([]);
    setSubRtVehTpRowData([]);
    setSubRtItemVehTpRowData([]);
    setSubRtItemVehRowData([]);

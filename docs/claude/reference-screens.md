...
| 중급형 (다중 sub) | `Location` | `master/account/location/` | `MasterDetailPage` (13탭 detail) | `main` + 13 sub | 메인 1행 → 다수 sub 동시 cascade(fan-out), `SUB_CONFIG` 매핑으로 액션 생성, **팝업 4종**(지도 보기/위경도 편집/차량 추가/구역 추가). |
